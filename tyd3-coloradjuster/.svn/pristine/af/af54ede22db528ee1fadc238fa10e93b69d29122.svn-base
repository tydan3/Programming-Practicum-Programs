...
public class BlueRowPanel extends JPanel implements PropertyChangeListener {
            ...
            public void actionPerformed(final ActionEvent theEvent) {
                if (isInteger(myValueField.getText())) {
                    ...
                    if (value < MIN_VALUE) {
                        ...
                        myColor.setBlue(MIN_VALUE);
                    } else if (value > MAX_VALUE) {
                        myValueField.setText("255");
                        myColor.setBlue(MAX_VALUE);
                    } else {
    ...
    public void propertyChange(final PropertyChangeEvent theEvent) {
        ...
        myDecreaseButton.setEnabled(myColor.getBlue() == MIN_VALUE);
        myIncreaseButton.setEnabled(myColor.getBlue() == MAX_VALUE);
    }
