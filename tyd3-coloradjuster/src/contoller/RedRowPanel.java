...
public class RedRowPanel extends JPanel implements PropertyChangeListener {
            ...
            public void actionPerformed(final ActionEvent theEvent) {
                if (isInteger(myValueField.getText())) {
                    ...
                    if (value < MIN_VALUE) {
                        ...
                        myColor.setRed(MIN_VALUE);
                    } else if (value > MAX_VALUE) {
                        myValueField.setText("255");
                        myColor.setRed(MAX_VALUE);
                    } else {
    ...
    public void propertyChange(final PropertyChangeEvent theEvent) {
        ...
        myDecreaseButton.setEnabled(myColor.getRed() != MIN_VALUE);
        myIncreaseButton.setEnabled(myColor.getRed() != MAX_VALUE);
    }
