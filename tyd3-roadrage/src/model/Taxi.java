...
public class Taxi extends AbstractVehicle {
    ...
    /** Amount of time before taxi runs crosswalk light. */
    private static final int DONE_WAITING = 3;
    /** Current time spent at red crosswalk light. */
    private int myWaitCycle;
    
    /**
     * Constructs a Taxi given an x coordinate, y coordinate, and direction.
